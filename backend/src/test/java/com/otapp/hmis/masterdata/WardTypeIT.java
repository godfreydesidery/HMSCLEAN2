...
/**
 * Negative-auth and smoke tests for {@code /api/v1/masterdata/ward-types}
 ...
 */
class WardTypeIT extends AbstractIntegrationTest {

    private static final String BASE = "/api/v1/masterdata/ward-types";
    ...
    void create_withoutToken_returns401() throws Exception {
        mockMvc.perform(post(BASE)
                        ...
                        .content(wardTypeJson("WT-401", "No Token WardType")))
    ...
    void create_withoutAdminAccess_returns403() throws Exception {
        ...
        mockMvc.perform(post(BASE)
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(wardTypeJson("WT-403", "Forbidden WardType")))
    ...
    void create_withAdminAccess_returns201WithLocationAndAuditRow() throws Exception {
        ...
        assertThat(auditLogRepository.findByEntityTypeOrderByOccurredAtAsc("masterdata.WardType"))
                .anyMatch(r -> r.getEntityUid().equals(uid) && r.getAction() == AuditAction.CREATE);
    }

    private String wardTypeJson(String code, String name) {
        return """
                {"code":"%s","name":"%s","description":"desc","price":30000.00,"active":true}
                """.formatted(code, name);
    }
}
