...
/**
 * Negative-auth and smoke tests for {@code /api/v1/masterdata/procedure-types}
 ...
 */
class ProcedureTypeIT extends AbstractIntegrationTest {

    private static final String BASE = "/api/v1/masterdata/procedure-types";
    ...
    void create_withoutToken_returns401() throws Exception {
        mockMvc.perform(post(BASE)
                        ...
                        .content(procedureTypeJson("PROC-401", "No Token ProcedureType")))
    ...
    void create_withoutAdminAccess_returns403() throws Exception {
        ...
        mockMvc.perform(post(BASE)
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(procedureTypeJson("PROC-403", "Forbidden ProcedureType")))
    ...
    void create_withAdminAccess_returns201WithLocationAndAuditRow() throws Exception {
        ...
        assertThat(auditLogRepository.findByEntityTypeOrderByOccurredAtAsc("masterdata.ProcedureType"))
                .anyMatch(r -> r.getEntityUid().equals(uid) && r.getAction() == AuditAction.CREATE);
    }

    private String procedureTypeJson(String code, String name) {
        return """
                {"code":"%s","name":"%s","description":"desc","price":12000.00,
