...
/**
 * Implementation of {@link DiagnosisTypeLookup} (package-private in {@code masterdata.application}).
 *
 * <p>Other modules consume the {@link DiagnosisTypeLookup} interface from
...
class DiagnosisTypeLookupImpl implements DiagnosisTypeLookup {
