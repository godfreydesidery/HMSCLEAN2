...
/**
 * Implementation of {@link RadiologyTypeLookup} (package-private in {@code masterdata.application}).
 *
 * <p>Other modules consume the {@link RadiologyTypeLookup} interface from
...
class RadiologyTypeLookupImpl implements RadiologyTypeLookup {
